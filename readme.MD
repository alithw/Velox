...
- **Windows**: Fully supported (CLI + Qt GUI)
- **Linux/macOS**: Supported with the Qt 6 GUI and the CLI

The legacy Win32 GUI (`VeloxPlayerGUI.cpp`) is Windows-only. The Qt 6 GUI (`velox_player`) is cross-platform.
